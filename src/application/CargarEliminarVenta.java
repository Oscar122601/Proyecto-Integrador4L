...
/**
 * Clase para cargar la vista de eliminación de venta en una ventana.
 */
public class CargarEliminarVenta {
    
    /**
     * Constructor de la clase.
     * @param st La ventana en la que se cargará la vista de eliminación de venta.
     */
    public CargarEliminarVenta(Stage st) {
        try {
            // Carga el archivo FXML que contiene la estructura de la vista de eliminación de venta
