...
/**
 * Clase para cargar la vista del buscador de productos en una ventana.
 */
public class CargarBuscadorProducto {
    
    /**
     * Constructor de la clase.
     * @param st La ventana en la que se cargará la vista del buscador de productos.
     */
    public CargarBuscadorProducto(Stage st) {
        try {
            // Carga el archivo FXML que contiene la estructura de la vista del buscador de productos
