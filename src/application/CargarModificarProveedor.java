...
/**
 * Clase para cargar la vista de modificación de proveedor en una ventana.
 */
public class CargarModificarProveedor {
    
    /**
     * Constructor de la clase.
     * @param st La ventana en la que se cargará la vista de modificación de proveedor.
     */
    public CargarModificarProveedor(Stage st) {
        try {
            // Carga el archivo FXML que contiene la estructura de la vista de modificación de proveedor
