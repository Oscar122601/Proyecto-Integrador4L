...
/**
 * Clase para cargar la vista de generación de cliente en una ventana.
 */
public class CargarGenerarCliente {
    
    /**
     * Constructor de la clase.
     * @param st La ventana en la que se cargará la vista de generación de cliente.
     */
    public CargarGenerarCliente(Stage st) {
        try {
            // Carga el archivo FXML que contiene la estructura de la vista de generación de cliente
