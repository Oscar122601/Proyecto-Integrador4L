...
/**
 * Clase para cargar la vista de generación de venta en una ventana.
 */
public class CargarGenerarVenta {
    
    /**
     * Constructor de la clase.
     * @param st La ventana en la que se cargará la vista de generación de venta.
     */
    public CargarGenerarVenta(Stage st) {
        try {
            // Carga el archivo FXML que contiene la estructura de la vista de generación de venta
