...
/**
 * Clase para cargar la vista de informe en una ventana.
 */
public class CargarInforme {
    
    /**
     * Constructor de la clase.
     * @param st La ventana en la que se cargará la vista del informe.
     */
    public CargarInforme(Stage st) {
        try {
            // Carga el archivo FXML que contiene la estructura de la vista del informe
